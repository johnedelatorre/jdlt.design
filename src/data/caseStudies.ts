...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title: 'Relo Census',
    subtitle: 'Building a 0→1 Sports Sponsorship Analytics Platform',
    client: 'Relo Metrics',
    role: 'Founding Product Design Lead',
    year: '2023 - 2024',
    tools: ['Figma', 'Pendo', 'Cursor', 'Claude', 'Figma MCP Server', 'Miro'],
        ...
        <div class="brief-section mb-8">
          ...
          <div class="findings-grid grid md:grid-cols-2 gap-6">
                ...
                <div class="finding-card bg-blue-50 border border-blue-200 rounded-lg p-6">
                  <h4 class="font-semibold text-gray-900 mb-4 flex items-center gap-3 text-xl">
                    <i class="fas fa-comments text-blue-600"></i>
                    Primary Research
                  </h4>
                  
                  <div class="mb-4">
                    <h5 class="font-semibold text-blue-900 mb-3 flex items-center gap-2 text-lg">
                      <i class="fas fa-circle text-blue-600 text-xs"></i>
                      Internal Stakeholder Interviews
                    </h5>
                    <ul class="space-y-2 text-gray-700 ml-4">
                      <li class="text-lg"><strong>2 Customer Success Managers:</strong> <em>"Too much training overhead"</em></li>
                      <li class="text-lg"><strong>2 Sales Directors:</strong> <em>"We're losing deals to competitors"</em></li>
                      <li class="text-lg"><strong>1 Marketing Manager:</strong> <em>"Can't tell our value story"</em></li>
                    </ul>
                  </div>
                  
                  <div class="mb-4">
                    <h5 class="font-semibold text-purple-900 mb-3 flex items-center gap-2 text-lg">
                      <i class="fas fa-circle text-purple-600 text-xs"></i>
                      Client Interviews
                    </h5>
                    <ul class="space-y-2 text-gray-700 ml-4">
                      <li class="text-lg"><strong>Kansas City Chiefs:</strong> <em>"Need asset-level valuation"</em></li>
                      <li class="text-lg"><strong>Optimum Sports:</strong> <em>"Let me build what I need"</em></li>
                      <li class="text-lg"><strong>Optimum Sports:</strong> <em>"Show me vs. competitors"</em></li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="finding-card bg-emerald-50 border border-emerald-200 rounded-lg p-6">
              ...
              <div class="mb-4">
                <h5 class="font-semibold text-orange-900 mb-3 flex items-center gap-2 text-lg">
                  <i class="fas fa-circle text-orange-600 text-xs"></i>
                  MVC Analytics (Pendo)
                </h5>
                <ul class="space-y-2 text-gray-700 ml-4">
                  <li class="text-lg">73% drop-off in onboarding</li>
                  <li class="text-lg">Users recreating same views daily</li>
                  <li class="text-lg">Average 6 support tickets per client</li>
                </ul>
              </div>
              
              <div class="mb-4">
                <h5 class="font-semibold text-pink-900 mb-3 flex items-center gap-2 text-lg">
                  <i class="fas fa-circle text-pink-600 text-xs"></i>
                  Market Analysis
                </h5>
                <ul class="space-y-2 text-gray-700 ml-4">
                  <li class="text-lg"><strong>Zoomph, Trajectory, SponsorUnited:</strong> lacking real-time data</li>
                  <li class="text-lg">No one offering true benchmarking</li>
                  <li class="text-lg">Gap in modular solutions</li>
                </ul>
                </div>
          </div>
      ...
      <div class="space-y-8 md:space-y-10">
        ...
        <div class="jobs-section">
          ...
          <div class="space-y-4">
            ...
            <!-- Universal Job -->
            <div class="job-card bg-blue-50 rounded-lg p-6">
              <h4 class="font-bold text-gray-900 text-2xl mb-4">Universal job (all personas):</h4>
              <ul class="space-y-3">
                <li class="flex items-start gap-3">
                  <i class="fas fa-circle text-blue-600 text-xs mt-2 flex-shrink-0"></i>
                  <span class="text-gray-700 text-xl">When I evaluate sponsorship performance, help me reach a defendable answer fast, reuse it, and explain it to stakeholders.</span>
                </li>
              </ul>
            </div>
            
            <!-- Brands Job -->
            <div class="job-card bg-teal-50 rounded-lg p-6">
              <h4 class="font-bold text-gray-900 text-2xl mb-4">Brands:</h4>
              <ul class="space-y-3">
                <li class="flex items-start gap-3">
                  <i class="fas fa-circle text-teal-600 text-xs mt-2 flex-shrink-0"></i>
                  <span class="text-gray-700 text-xl">Allocate budget to what works; defend strategy with an exec-ready, explainable view; track shifts via the same saved view</span>
                </li>
              </ul>
            </div>
            
            <!-- Agencies Job -->
            <div class="job-card bg-cyan-50 rounded-lg p-6">
              <h4 class="font-bold text-gray-900 text-2xl mb-4">Agencies:</h4>
              <ul class="space-y-3">
                <li class="flex items-start gap-3">
                  <i class="fas fa-circle text-cyan-600 text-xs mt-2 flex-shrink-0"></i>
                  <span class="text-gray-700 text-xl">Build scenarios across properties & audiences; benchmark credibly; package evidence via shared views</span>
                </li>
              </ul>
            </div>
            
            <!-- Placement Types (Rights Holders) Job -->
            <div class="job-card bg-slate-50 rounded-lg p-6">
              <h4 class="font-bold text-gray-900 text-2xl mb-4">Placement Types (Rights Holders):</h4>
              <ul class="space-y-3">
                <li class="flex items-start gap-3">
                  <i class="fas fa-circle text-slate-600 text-xs mt-2 flex-shrink-0"></i>
                  <span class="text-gray-700 text-xl">Prove partner value at asset level; benchmark vs peers/league; create repeatable recap views for renewals</span>
                </li>
              </ul>
            </div>
        ...
        <div class="job-map-section">
          ...
          <div class="bg-teal-50 rounded-lg p-6">
            <ul class="space-y-3">
              <li class="flex items-start gap-3">
                <i class="fas fa-arrow-right text-teal-600 text-lg mt-1 flex-shrink-0"></i>
                <span class="text-gray-700 text-xl">Define question → Set scope (league/team/brand/asset/channel/timeframe) → Deep filter → Compare/benchmark → Read brief explainer → Save & share → Reuse.</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="bg-slate-50 rounded-lg p-6">
            <ul class="space-y-4">
              <li class="flex items-start gap-3">
                <i class="fas fa-circle text-slate-600 text-xs mt-2 flex-shrink-0"></i>
                <div>
                  <span class="font-bold text-gray-900 text-xl">Activation:</span>
                  <span class="text-gray-700 text-xl"> users reach and save a view in the first session.</span>
                </div>
              </li>
              <li class="flex items-start gap-3">
                <i class="fas fa-circle text-slate-600 text-xs mt-2 flex-shrink-0"></i>
                <div>
                  <span class="font-bold text-gray-900 text-xl">Ongoing use:</span>
                  <span class="text-gray-700 text-xl"> saved views are reopened/shared.</span>
                </div>
              </li>
              <li class="flex items-start gap-3">
                <i class="fas fa-circle text-slate-600 text-xs mt-2 flex-shrink-0"></i>
                <div>
                  <span class="font-bold text-gray-900 text-xl">Fewer tickets:</span>
                  <span class="text-gray-700 text-xl"> fewer "what does this metric mean?" questions.</span>
                </div>
              </li>
            </ul>
          </div>
    ...
    `,
    images: [
      '/images/case-studies/relo-census/relocensususerflow.png?v=2',
